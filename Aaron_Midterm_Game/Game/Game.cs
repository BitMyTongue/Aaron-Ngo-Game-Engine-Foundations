...
namespace MidtermGame
{
    public class Game : GameWindow
    {
        ...
        private Vector3 housePosition = new Vector3(0, 0, -7f);                 // Mannually adjusted
        
        private Mesh doorMesh;
        private Texture doorTexture;
        private Vector3 doorPosition = new Vector3(0.1f, -0.1f, -7.035f);       // Mannually adjusted
        ...
        protected override void OnLoad()
        {
            ...
            keyTexture = new Texture("Assets/Textures/key.jpg");
            ...
            groundTexture = new Texture("Assets/Textures/grass.jpeg");

            // Lantern
            lanternMesh = Mesh.LoadFromObj("Assets/lantern.obj");
            lanternTexture = new Texture("Assets/Textures/lantern.jpg");

            // Table
            tableMesh = Mesh.LoadFromObj("Assets/table.obj");
            tableTexture = new Texture("Assets/Textures/table.jpg");

            // House
            houseMesh = Mesh.LoadFromObj("Assets/house.obj");
            houseTexture = new Texture("Assets/Textures/house.jpg");

            // Door
            doorMesh = Mesh.LoadFromObj("Assets/door.obj");
            doorTexture = new Texture("Assets/Textures/door.jpg");
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if (KeyboardState.IsKeyDown(OpenTK.Windowing.GraphicsLibraryFramework.Keys.W))
                camera.Move(flatFront, moveSpeed);
            ...
            if (KeyboardState.IsKeyDown(OpenTK.Windowing.GraphicsLibraryFramework.Keys.A))
                camera.Move(-flatRight, moveSpeed);
